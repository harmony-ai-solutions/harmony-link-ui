...
This project is indexed by GitNexus as **frontend** (1624 symbols, 3218 relationships, 137 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
