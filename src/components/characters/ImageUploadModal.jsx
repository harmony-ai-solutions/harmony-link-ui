            ...
            <div className="bg-white rounded-lg p-6 max-w-md w-full mx-4">
                ...
                <div className="space-y-4">
                    ...
                    <div>
                        ...
                        />
                        <p className="mt-1 text-xs text-gray-500">PNG, JPEG, or WEBP. Max 10MB.</p>
                    </div>
                    ...
                    <div className="flex justify-end gap-2 pt-4">
                        <button
                            onClick={onClose}
                            disabled={uploading}
                            className="px-4 py-2 border border-gray-300 rounded-lg hover:bg-gray-50 transition-colors disabled:opacity-50 text-gray-700"
                        >
                            Cancel
                        </button>
                        <button
