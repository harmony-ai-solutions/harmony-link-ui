...
const BackendOpenRouterSettingsView = ({initialSettings, saveSettingsFunc}) => {
    ...
    const refreshAvailableModels = async () => {
        ...
        try {
            const result = await listProviderModels(MODULES.BACKEND, PROVIDERS.OPENROUTER, currentConfig);
            if (result.error) {
    ...
    const handleValidateConfig = async () => {
        ...
        try {
            const result = await validateProviderConfig(MODULES.BACKEND, PROVIDERS.OPENROUTER, currentConfig);
            setValidationState({
...
export default BackendOpenRouterSettingsView;
