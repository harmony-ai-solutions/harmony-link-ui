                    ...
                    <div className="flex items-center mb-6 w-full">
                        <label className="block text-sm font-medium text-gray-300 w-1/6 px-3">
                            ...
                            <SettingsTooltip tooltipIndex={1} tooltipVisible={() => tooltipVisible}
                                ...
                                The name of the embedding model to use with LocalAI.
                                <br/>This should match the model name configured in your LocalAI instance.
                                <br/>Common examples include: text-embedding-ada-002, all-MiniLM-L6-v2, etc.
                            </SettingsTooltip>
                        </label>
...
export default RAGLocalAISettingsView;
