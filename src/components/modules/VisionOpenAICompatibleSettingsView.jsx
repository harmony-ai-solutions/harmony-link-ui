...
const VisionOpenAICompatibleSettingsView = ({initialSettings, saveSettingsFunc}) => {
    // Merge initial settings with defaults
    const defaults = MODULE_DEFAULTS[MODULES.VISION][PROVIDERS.OPENAI_COMPATIBLE];
    ...
    const refreshAvailableModels = async () => {
        ...
        try {
            const result = await listProviderModels(MODULES.VISION, PROVIDERS.OPENAI_COMPATIBLE, currentConfig);
            if (result.error) {
    ...
    const handleValidateConfig = async () => {
        ...
        try {
            const result = await validateProviderConfig(MODULES.VISION, PROVIDERS.OPENAI_COMPATIBLE, currentConfig);
            setValidationState({
    ...
    return(
        <>
            <div className="flex flex-wrap w-full pt-2">
                ...
                />
                <IntegrationDisplay moduleName={MODULES.VISION} providerName={PROVIDERS.OPENAI_COMPATIBLE} useIntegration={useIntegration} />
...
export default VisionOpenAICompatibleSettingsView;
