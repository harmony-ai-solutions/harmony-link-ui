...
const VisionOpenAISettingsView = ({initialSettings, saveSettingsFunc}) => {
    // Merge initial settings with defaults
    const defaults = MODULE_DEFAULTS[MODULES.VISION][PROVIDERS.OPENAI];
    ...
    const refreshAvailableModels = async () => {
        ...
        try {
            const result = await listProviderModels(MODULES.VISION, PROVIDERS.OPENAI, currentConfig);
            if (result.error) {
    ...
    const handleValidateConfig = async () => {
        ...
        try {
            const result = await validateProviderConfig(MODULES.VISION, PROVIDERS.OPENAI, currentConfig);
            setValidationState({
...
export default VisionOpenAISettingsView;
