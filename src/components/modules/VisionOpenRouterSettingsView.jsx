...
const VisionOpenRouterSettingsView = ({initialSettings, saveSettingsFunc}) => {
    // Merge initial settings with defaults
    const defaults = MODULE_DEFAULTS[MODULES.VISION][PROVIDERS.OPENROUTER];
    ...
    const refreshAvailableModels = async () => {
        ...
        try {
            const result = await listProviderModels(MODULES.VISION, PROVIDERS.OPENROUTER, currentConfig);
            if (result.error) {
    ...
    const handleValidateConfig = async () => {
        ...
        try {
            const result = await validateProviderConfig(MODULES.VISION, PROVIDERS.OPENROUTER, currentConfig);
            setValidationState({
...
export default VisionOpenRouterSettingsView;
