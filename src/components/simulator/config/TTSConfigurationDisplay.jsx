...
function TTSConfigurationDisplay({ config, loading, error }) {
    ...
    if (!config) {
        return (
            <div className="bg-neutral-700 rounded p-4">
                <div className="text-gray-400">No TTS configuration available</div>
            </div>
        );
    }
    ...
    return (
        <div className="bg-neutral-700 rounded p-4">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                    <h5 className="font-medium text-emerald-400 mb-2">Provider Configuration</h5>
                ...
                <div>
                    <h5 className="font-medium text-emerald-400 mb-2">Voice Settings</h5>
                    <div className="space-y-2 text-sm">
