        ...
        <div className="p-3 bg-gradient-to-br from-neutral-800 to-neutral-900 min-h-full">
            <div className="mb-3">
                <div className="flex items-center gap-2 mb-1">
                    ...
                    <div>
                        <h3 className="text-lg font-bold text-white">Movement Module Simulation</h3>
                        <p className="text-gray-400 text-xs">Action Processing • Scene Management • Movement Coordination</p>
                    </div>
                </div>
            </div>
            ...
            {connectionStatus !== 'connected' ? (
                ...
                <div className="space-y-2">
                    <div className="bg-neutral-800/50 backdrop-blur-sm rounded-lg border border-neutral-700/50 overflow-hidden">
                        <div className="bg-gradient-to-r from-cyan-500/10 to-cyan-600/10 border-b border-cyan-500/20 p-2">
                            <div className="flex items-center gap-2">
                                ...
                                <div>
                                    ...
                                    <p className="text-cyan-300/70 text-xs">Current movement provider and settings</p>
                                </div>
                            </div>
                        </div>
                        <div className="p-3">
                        ...
                        <div className="bg-gradient-to-r from-green-500/10 to-green-600/10 border-b border-green-500/20 p-2">
                            <div className="flex items-center gap-2">
                                ...
                                <div>
                                    ...
                                    <p className="text-green-300/70 text-xs">Test movement functionality with scene data and action registration</p>
                                </div>
                            </div>
                        </div>
                        <div className="p-3">
                            <div className="grid grid-cols-1 xl:grid-cols-3 gap-3">
                                <div className="bg-neutral-700/30 rounded border border-neutral-600/50 p-3">
                                    <div className="flex items-center gap-2 mb-2">
                                        ...
                                        <h5 className="text-xs font-semibold text-white">Environment Events</h5>
                                    </div>
                                    <div className="space-y-2">
                                ...
                                <div className="bg-neutral-700/30 rounded border border-neutral-600/50 p-3">
                                    <div className="flex items-center gap-2 mb-2">
                                        ...
                                        <h5 className="text-xs font-semibold text-white">Scene Data</h5>
                                    </div>
                                    <SceneDataForm 
                                ...
                                <div className="bg-neutral-700/30 rounded border border-neutral-600/50 p-3">
                                    <div className="flex items-center gap-2 mb-2">
                                        ...
                                        <h5 className="text-xs font-semibold text-white">Register Actions</h5>
                                    </div>
                                    <RegisterActionsForm 
                                        onSendEvent={(event) => onSendEvent(event, 'movement')} 
                                        formState={formResponses.movement}
