        ...
        <div className="p-4 bg-gradient-to-br from-neutral-800 to-neutral-900 min-h-full">
            <div className="mb-6">
                <div className="flex items-center gap-3 mb-2">
                    ...
                    <div>
                        <h3 className="text-xl font-bold text-white">RAG Module Simulation</h3>
                        <p className="text-gray-400 text-sm">Retrieval-Augmented Generation • Vector Embeddings • Action Matching</p>
                    </div>
                </div>
            </div>
                        ...
                        <div className="bg-gradient-to-r from-orange-500/10 to-orange-600/10 border-b border-orange-500/20 p-4">
                            <div className="flex items-center gap-3">
                                ...
                                <div>
                                    ...
                                    <p className="text-orange-300/70 text-sm">Current RAG provider and settings</p>
                                </div>
                            </div>
                        </div>
                        <div className="p-4">
                    ...
                    <div className="bg-neutral-800/50 backdrop-blur-sm rounded-xl border border-neutral-700/50 overflow-hidden">
                        <div className="bg-gradient-to-r from-blue-500/10 to-blue-600/10 border-b border-blue-500/20 p-4">
                            <div className="flex items-center gap-3">
                                ...
                                <div>
                                    <h4 className="text-lg font-semibold text-white">Vector Collections</h4>
                                    <p className="text-blue-300/70 text-sm">Manage your vector embeddings and documents</p>
                                </div>
                            </div>
                        </div>
                        <div className="p-4">
                        ...
                        <div className="bg-gradient-to-r from-green-500/10 to-green-600/10 border-b border-green-500/20 p-4">
                            <div className="flex items-center gap-3">
                                ...
                                <div>
                                    ...
                                    <p className="text-green-300/70 text-sm">Test RAG functionality with sync and match operations</p>
                                </div>
                            </div>
                        </div>
                        <div className="p-4">
                            <div className="grid grid-cols-1 xl:grid-cols-2 gap-4">
                                <div className="bg-neutral-700/30 rounded-lg border border-neutral-600/50 p-4">
                                    <div className="flex items-center gap-2 mb-3">
                                        ...
                                        <h5 className="text-sm font-semibold text-white">Sync Actions</h5>
                                    </div>
                                    <RAGSyncActionsForm 
                                ...
                                <div className="bg-neutral-700/30 rounded-lg border border-neutral-600/50 p-4">
                                    <div className="flex items-center gap-2 mb-3">
                                        ...
                                        <h5 className="text-sm font-semibold text-white">Match Actions</h5>
                                    </div>
                                    <RAGMatchActionsForm 
                                        onSendEvent={(event) => onSendEvent(event, 'rag')} 
                                        formState={formResponses.rag}
