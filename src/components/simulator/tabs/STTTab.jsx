        ...
        <div className="p-3 bg-gradient-to-br from-neutral-800 to-neutral-900 min-h-full">
            <div className="mb-3">
                <div className="flex items-center gap-2 mb-1">
                    ...
                    <div>
                        <h3 className="text-lg font-bold text-white">STT Module Simulation</h3>
                        <p className="text-gray-400 text-xs">Speech-to-Text • Audio Recognition • Voice Processing</p>
                    </div>
                </div>
            </div>
            ...
            {connectionStatus !== 'connected' ? (
                ...
                <div className="space-y-2">
                    <div className="bg-neutral-800/50 backdrop-blur-sm rounded-lg border border-neutral-700/50 overflow-hidden">
                        <div className="bg-gradient-to-r from-indigo-500/10 to-indigo-600/10 border-b border-indigo-500/20 p-2">
                            <div className="flex items-center gap-2">
                                ...
                                <div>
                                    ...
                                    <p className="text-indigo-300/70 text-xs">Current STT provider and recognition settings</p>
                                </div>
                            </div>
                        </div>
                        <div className="p-3">
                        ...
                        <div className="bg-gradient-to-r from-green-500/10 to-green-600/10 border-b border-green-500/20 p-2">
                            <div className="flex items-center gap-2">
                                ...
                                <div>
                                    ...
                                    <p className="text-green-300/70 text-xs">Test STT functionality with audio input</p>
                                </div>
                            </div>
                        </div>
                        <div className="p-3">
                            <div className="bg-neutral-700/30 rounded border border-neutral-600/50 p-3">
                                <div className="flex items-center gap-2 mb-2">
                                    ...
                                    <h5 className="text-xs font-semibold text-white">Process Audio</h5>
                                </div>
                                <STTForm 
