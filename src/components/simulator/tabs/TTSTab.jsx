        ...
        <div className="p-4 bg-gradient-to-br from-neutral-800 to-neutral-900 min-h-full">
            <div className="mb-6">
                <div className="flex items-center gap-3 mb-2">
                    ...
                    <div>
                        <h3 className="text-xl font-bold text-white">TTS Module Simulation</h3>
                        <p className="text-gray-400 text-sm">Text-to-Speech • Voice Synthesis • Audio Generation</p>
                    </div>
                </div>
            </div>
            ...
            {connectionStatus !== 'connected' ? (
                ...
                <div className="space-y-5">
                    <div className="bg-neutral-800/50 backdrop-blur-sm rounded-xl border border-neutral-700/50 overflow-hidden">
                        <div className="bg-gradient-to-r from-emerald-500/10 to-emerald-600/10 border-b border-emerald-500/20 p-4">
                            <div className="flex items-center gap-3">
                                ...
                                <div>
                                    ...
                                    <p className="text-emerald-300/70 text-sm">Current TTS provider and voice settings</p>
                                </div>
                            </div>
                        </div>
                        <div className="p-4">
                        ...
                        <div className="bg-gradient-to-r from-green-500/10 to-green-600/10 border-b border-green-500/20 p-4">
                            <div className="flex items-center gap-3">
                                ...
                                <div>
                                    ...
                                    <p className="text-green-300/70 text-sm">Test TTS functionality with text synthesis</p>
                                </div>
                            </div>
                        </div>
                        <div className="p-4">
                            <div className="bg-neutral-700/30 rounded-lg border border-neutral-600/50 p-4">
                                <div className="flex items-center gap-2 mb-3">
                                    ...
                                    <h5 className="text-sm font-semibold text-white">Generate Speech</h5>
                                </div>
                                <TTSForm 
